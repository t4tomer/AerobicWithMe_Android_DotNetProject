...
<div style="display: flex; justify-content: space-between;">
    <img src="Images/pic1.png" alt="List of Tracks" width="30%">
    <img src="Images/pic2.png" alt="Route Creation" width="30%">
    <img src="Images/pic3.png" alt="All User Records" width="30%">
</div>

<div style="display: flex; justify-content: space-between;">
    <img src="Images/pic4.png" alt="User Records By Map" width="30%">
    <img src="Images/pic5.png" alt="Sort User Records" width="30%">
    <img src="Images/pic6.png" alt="Show Distance Of Track" width="30%">
</div>

<div style="display: flex; justify-content: space-between;">
    <img src="Images/pic7.png" alt="Upload New User Record" width="30%">
    <img src="Images/pic8.png" alt="Edit Pin Name" width="30%">
    <img src="Images/pic9.png" alt="Add New Track" width="30%">
</div>
